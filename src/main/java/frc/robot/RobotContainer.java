...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        m_Chooser.setDefaultOption("Choose Command",
                new SequentialCommandGroup(new InstantCommand(m_drive::driveStop), new HomingCommand(m_manipulator)));
        ...
        m_Chooser.addOption("take targets",
                new SequentialCommandGroup(new HomingCommand(m_manipulator), new AutoMoveBackwards(m_drive),
                        new AutoRotateLeft(m_drive), new AutoMoveForward(m_drive)));
        m_Chooser.addOption("AutoForwards",
                new SequentialCommandGroup(new HomingCommand(m_manipulator), new AutoMoveForward(m_drive)));
        m_Chooser.addOption("turn around",
                new SequentialCommandGroup(new HomingCommand(m_manipulator), new AutoForwardTarget(m_drive),
                        new AutoTurnAround(m_drive), new AutoMoveForward(m_drive)));
        m_Chooser.addOption("Pass Station adn back",
                new SequentialCommandGroup(new HomingCommand(m_manipulator),
    ...
    private void configureBindings() {
        ...
        forearmExtendButton = new JoystickButton(joystickManipulator, OperatorConstants.kManipulatorInputRetract);
        forearmRetractButton = new JoystickButton(joystickManipulator, OperatorConstants.kManipulatorInputExtend);
